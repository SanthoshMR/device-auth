...
module.exports = function(){
  ...
  return {
     ...
     * methods.
     *
     * @param  {object} actions device defiend actions
     * @return {object} device actions merged with template
     */
    ...
    /**
     * bootstraps device defined overrides with template actions
     *
     * @param  {object} actions device defiend actions
     * @return {object} device actions merged with template
     */
    device: function(actions){
      waterlock.logger.verbose('bootstraping device actions');
